...
function populateCommodityList() {
 ...
 var listCommodity = '<table > <tr> <th>Category</th> <th>Name</th> <th>Status</th> <th>Delete?</th> </tr>';
...
// jQuery AJAX call for JSON
 ...
 'id="status_' + this._id + '">' + this.status + '<button data="' + this._id + '" class="myButton" onclick="showStatusOptions(event,this)">update</button>'
 + '</td><td>'+'<button data="' + this._id + '" class="myButton" onclick="deleteCommodity(event,this)">delete</button>'+'</td></tr>';
 });
 listCommodity += '</table>'
